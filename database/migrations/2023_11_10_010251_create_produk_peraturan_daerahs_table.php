...
return new class extends Migration
{
    ...
    {
        Schema::create('bpp_produk_peraturan_daerahs', function (Blueprint $table) {
            $table->id();
            $table->enum('tipe_peraturan', ['PERATURAN PERUNDANG-UNDANGAN']);
            $table->text('judul');
    ...
    {
        Schema::dropIfExists('bpp_produk_peraturan_daerahs');
    }
};
