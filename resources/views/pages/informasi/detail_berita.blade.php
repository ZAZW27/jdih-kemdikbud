...
@include('pages.partials.__header')
    ...
    <div class="containers bg-center pb-10 -mt-[9rem]">
                ...
                <div class="grid grid-cols-1 grid-forms md:grid-row gap-3 pb-12">
                    <div class="berita-container col-span-1 animate-slide-up" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
                        <div class="berita-bannerpic w-[100%] lg:h-[70rem]  ">
                            <img class="w-[100%] rounded-lg shadow-xl sticky top-[7rem]" src="{{asset('assets/img/media/berita-14.jpg')}}" alt="" >
                        </div>
                        <div class="card shadow-xl pb-12 pt-2 content berita-card lg:mx-12 relative lg:-top-[30rem] ">
                            <div class="lg:px-[40px] md:px-[30px] py-[15px] rounded-border-content ">
                                <div class="text-justify">
                                    <div class="pt-4 mx-auto">
                                        <div class="w-full detail-berita-content">
                                            <div class="w-full">
                                                <h1 class="text-3xl font-semibold font-sans text-start">Kemendikbudristek Kembali Dorong Pelaksanaan PTM Terbatas Mengikuti Ketentuan SKB Empat Menteri</h1>
                                                <div class="flex justify-between mt-4">
                                                    <div class="font-bold text-yellow-600 ">Umum | 13 Oktober 2023 </div>
        ...
        <div class="lg:-mt-[30rem]  lg:px-[6rem] px-4 mx-auto max-w-screen-xl text-center z-10 relative">
