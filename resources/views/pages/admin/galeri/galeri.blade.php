...
<div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg">
        <div class="relative top-[0px] md:top-[50px] right-0">
            <a href="{{route('galeri-baru')}}" class="flex justify-center w-20 h-auto bg-blue-500 rounded-lg drop-shadow-md text-white font-semibold py-1">NEW+</a>
        </div>
                    ...
                    <tbody>
                        @foreach ($galeri as $q)
                            <tr class="bg-white border-b hover:bg-sky-50">
                                ...
                                <td class="px-6 py-4">
                                    {{ Illuminate\Support\Str::limit($q->exerpt, $limit = 100, $end = '. . .') }}
                                </td>
                                <td class="px-1 py-4">
                                    <div class="flex flex-row justify-center align-center items-center px-2 py-4">
                                        <a href="{{route('edit-galeri/', ['id' => $q->id])}}" class="font-medium text-blue-600 hover:underline">Edit</a>
