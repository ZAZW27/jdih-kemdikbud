            ...
            <div class="relative overflow-x-auto sm:rounded-lg py-4 w-full px-6">
                <form action="{{route('proses-insert-berita')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="relative z-0 w-full mb-6 group">                        
                        ...
                        <input name="judul" value="" type="text" id="email" aria-describedby="helper-text-explanation" class="shadow bg-white border border-slate-500 text-gray-900 text-sm rounded-lg focus:ring-blue-300 focus:border-sky-800 block w-full p-2.5  transition-all duration-200 ease-out">
                    </div>
                    <div class="relative z-0 w-full mb-2 group">
                        <label class="block mb-2 text-sm font-medium text-gray-900 " for="user_avatar">Gambar berita</label>
                        <input name="gambar" value="" class="block w-full text-sm text-slate-900 border border-slate-600 rounded-lg cursor-pointer bg-white shadow focus:outline-none" aria-describedby="user_avatar_help" id="user_avatar" type="file">
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                            ...
                            <input name="tema" value="" type="text" id="email" aria-describedby="helper-text-explanation" class="shadow bg-white border border-slate-500 text-gray-900 text-sm rounded-lg focus:ring-blue-300 focus:border-sky-800 block w-full p-2.5  transition-all duration-200 ease-out">
                        </div>
                        <div class="relative z-0 w-full mb-6 group">
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-900">Tanggal berita</label>
                            <input name="tanggal" value="" type="date" id="email" aria-describedby="helper-text-explanation" class="shadow bg-white border border-slate-500 text-gray-900 text-sm rounded-lg focus:ring-blue-300 focus:border-sky-800 block w-full p-2.5  transition-all duration-200 ease-out">
                        </div>
                    </div>
                    <div class="relative z-0 w-full mb-6 group">                        
