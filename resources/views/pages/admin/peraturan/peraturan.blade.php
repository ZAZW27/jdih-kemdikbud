        ...
        <div class="flex items-center justify-center h-auto rounded bg-gray-50">
            <div class="relative overflow-x-auto sm:rounded-lg">
                @foreach ($peraturan as $per)
                    <div class=" py-2 px-4 flex flex-col flex-wrap justify-start bg-none hover:bg-sky-300/10 w-[300%] transition-all duration-200 ease-in">
                        <div class="flex flex-col flex-wrap justify-start items-start border-b-4 border-blue-800/50">
                            <div class="sticky left-2">
                                <div class="relative md:-mb-6 mb-0 flex flex-row md:justify-end justify-start align-start items-start">
                                    <a href="#" class="font-medium text-blue-600 hover:underline">Edit</a>
                                    <a href="#" class="font-medium text-red-600 hover:underline ms-3">Remove</a>
                                </div>
                                <div class="flex flex-col flex-wrap justify-start items-start lg:max-w-[77vw] md:max-w-[60vw] max-w-[90vw]">
                                    <h6 class="text-yellow-600 font-semibold text-sm">
