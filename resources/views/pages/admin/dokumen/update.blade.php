            ...
            <div class="relative overflow-x-auto sm:rounded-lg py-4 w-full px-6">
                <form action="{{route('proses-update-berita')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="relative z-0 w-full mb-6 group">                        
                        ...
                        <textarea name="isi" id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-slate-800 focus:ring-none focus:border-none" placeholder="beri isi pada berita">{{$berita->isi}}</textarea>
                    </div>
