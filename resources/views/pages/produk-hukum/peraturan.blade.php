                ...
                <div class="row-span-3 shadow-md col-span-12 ">
                    <form class="relative domain-form md:z-[46] z-[80]" action="{{route('get_peraturan.data')}}" method="post">
                        ...
                        <div class="md:flex md:items-center md:space-x-4 tutup animate-slide-left">
                            ...
                            <div class="absolute right-6 flex md:mt-0 transition-all duration-200 ease-out" id="filter-button">
                        ...
                        <div class="absolute w-full flex hidden md:justify-center justify-center md:-mt-14 md:top-[20svh] " id="filter-options" >
