                            ...
                            <form class="relative domain-form md:z-[46] z-[80]" action="{{route('get_peraturan.data')}}" method="post">
                                ...
                                <div class="relative flex justify-center items-center">
                                    <div class="relative md:w-[50%] w-[80%] flex flex-col justify-center md:items-center">
                                        ...
                                        {{-- px-0 md:px-[10vw] --}}
                                        <div class="flex md:mt-2 marquee-body pointer-events-none">
                ...
                <script>
                    $(document).ready(function () {
                        ...
                        function handleScroll() {
                            ...
                            var positionVal = scrollVal * 0.5 - 300

                            peraturanBg.css('bottom', "-" + positionVal + 'px');
                            // console.log("big");
                        }

                        // Function to handle resizing logic
                        function handleResize() {
                            // Check if the window width is large (lg)
                            // console.log(window.innerWidth)
                            if (window.innerWidth >= 1024) {
                                peraturanBg.removeClass('bg-cover object-cover h-full')
                                $(window).on('scroll', handleScroll);
                            } else {
                                peraturanBg.css({
                                    'bottom': '0px',
                                });
                                peraturanBg.addClass('bg-cover object-cover h-full')
                                // console.log("small");
                ...
                <div class="relative inset-0 bg-black/60 h-full w-full z-20 flex items-start justify-center">
                    <div class="py-4 px-4 md:px-10 lg:px-20 min-h-[60vh] lg:min-h-full h-full w-full flex flex-col items-center justify-between">
                        <div class="flex flex-wrap justify-center items-start w-full h-auto my-2 md:mb-12 md:mt-4">
                            <div class="w-[9rem] md:w-[13rem] lg:w-[16rem] p-4 m-2 flex flex-col justify-center items-center bg-blue-100/10 shadow-lg rounded-sm backdrop-blur-none transition-all duration-300 ease-in-out hover:scale-110 z-20 hover:z-30 hover:backdrop-blur-sm hover:bg-blue-50/20 hover:rounded-md">
                                <div class="peraturan-icon rounded-full min-h-8 max-h-8 scale-75 md:scale-100">
                                ...
                                <div class="detail-peratiran-container flex flex-col justify-center items-center text-white">
                                    <div class="peraturan-nomor text-[28px] md:text-[52px]">{{$cPerda->first()->count_JP}}</div>
                                    <div class="peraturan-nama text-[0.5rem] md:text-[0.9rem]  text-center">PERATURAN DAERAH</div>
                                </div>
                            </div>
                            <div class="w-[9rem] md:w-[13rem] lg:w-[16rem] p-4 m-2 flex flex-col justify-center items-center bg-blue-100/10 shadow-lg rounded-sm backdrop-blur-none transition-all duration-300 ease-in-out hover:scale-110 z-20 hover:z-30 hover:backdrop-blur-sm hover:bg-blue-50/20 hover:rounded-md">
                                <div class="peraturan-icon rounded-full min-h-8 max-h-8 scale-75 md:scale-100">
                                ...
                                <div class="detail-peratiran-container flex flex-col justify-center items-center text-white">
                                    <div class="peraturan-nomor text-[28px] md:text-[52px]">{{$cPerwal->first()->count_JP}}</div>
                                    <div class="peraturan-nama text-[0.5rem] md:text-[0.9rem]  text-center">PERATURAN WALI</div>
                                </div>
                            </div>
                            <div class="w-[9rem] md:w-[13rem] lg:w-[16rem] p-4 m-2 flex flex-col justify-center items-center bg-blue-100/10 shadow-lg rounded-sm backdrop-blur-none transition-all duration-300 ease-in-out hover:scale-110 z-20 hover:z-30 hover:backdrop-blur-sm hover:bg-blue-50/20 hover:rounded-md">
                                <div class="peraturan-icon rounded-full min-h-8 max-h-8 scale-75 md:scale-100">
                                ...
                                <div class="detail-peratiran-container flex flex-col justify-center items-center text-white">
                                    <div class="peraturan-nomor text-[28px] md:text-[52px]">{{$cSU->first()->count_JP}}</div>
                                    <div class="peraturan-nama text-[0.5rem] md:text-[0.9rem]  text-center">SURAT EDARAN WALI </div>
                                </div>
                            </div>
                            <div class="w-[9rem] md:w-[13rem] lg:w-[16rem] p-4 m-2 flex flex-col justify-center items-center bg-blue-100/10 shadow-lg rounded-sm backdrop-blur-none transition-all duration-300 ease-in-out hover:scale-110 z-20 hover:z-30 hover:backdrop-blur-sm hover:bg-blue-50/20 hover:rounded-md">
                                <div class="peraturan-icon rounded-full min-h-8 max-h-8 scale-75 md:scale-100">
                                ...
                                <div class="detail-peratiran-container flex flex-col justify-center items-center text-white">
                                    <div class="peraturan-nomor text-[28px] md:text-[52px]">{{$cInstruksi->first()->count_JP}}</div>
                                    <div class="peraturan-nama text-[0.5rem] md:text-[0.9rem]  text-center">INSTRUKSI WALI </div>
                                </div>
                            </div>
                            <div class="w-[9rem] md:w-[13rem] lg:w-[16rem] p-4 m-2 flex flex-col justify-center items-center bg-blue-100/10 shadow-lg rounded-sm backdrop-blur-none transition-all duration-300 ease-in-out hover:scale-110 z-20 hover:z-30 hover:backdrop-blur-sm hover:bg-blue-50/20 hover:rounded-md">
                                <div class="peraturan-icon rounded-full min-h-8 max-h-8 scale-75 md:scale-100">
                                ...
                                <div class="detail-peratiran-container flex flex-col justify-center items-center text-white">
                                    <div class="peraturan-nomor text-[28px] md:text-[52px]">{{$cMOU->first()->count_JP}}</div>
                                    <div class="peraturan-nama text-[0.5rem] md:text-[0.9rem]  text-center">MOU </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="py-4 px-4 mx-auto max-w-screen-xl text-center z-10 relative">
            <div id="default-carousel" class="relative w-full" data-carousel="slide">
                ...
                <button type="button" class="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
                    <span class="inline-flex items-center justify-center w-12 h-12 rounded-full transition-all duration-700 ease-out group-focus:outline-none">
